...
from odoo.addons.shopinvader_restapi.tests.common import ShopinvaderRestCase
...
class ShopinvaderControllerCase(ShopinvaderRestCase):
    def setUp(self, *args, **kwargs):
        ...
        self.address_1 = self.env.ref("shopinvader_restapi.partner_1_address_1")
        self.address_2 = self.env.ref("shopinvader_restapi.partner_1_address_2")
