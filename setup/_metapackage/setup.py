...
setuptools.setup(
    ...
    install_requires=[
        ...
        'odoo-addon-shopinvader_api_mass_mailing>=16.0dev,<16.1dev',
        ...
        'odoo-addon-shopinvader_api_warehouse>=16.0dev,<16.1dev',
        ...
        'odoo-addon-shopinvader_fastapi_auth_partner>=16.0dev,<16.1dev',
