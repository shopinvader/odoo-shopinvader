...
setuptools.setup(
    ...
    install_requires=[
        ...
        'odoo14-addon-shopinvader_customer_autobind',
        ...
        'odoo14-addon-shopinvader_locomotive_product_seasonality',
        ...
        'odoo14-addon-shopinvader_product_seasonality',
        'odoo14-addon-shopinvader_product_seasonality_search_engine',
        ...
        'odoo14-addon-shopinvader_sale_profile_update_price',
