...
class TestQuotation(MailCommon):
    @classmethod
    def setUpClass(cls):
        super().setUpClass()
    ...
    def test_send_request_notification(self):
        ...
        self.assertEqual(self.so.typology, "cart")
        ...
        with self.mock_mail_gateway():
            ...
            self.assertMailMail(
                ...
                email_values={
                    ...
                    f"Quotation Request (Ref {self.so.name})",
                    "email_from": self.so.user_id.company_id.email_formatted,
                },
            )

    def test_send_request_notification_no_recipients(self):
        ...
        with self.mock_mail_gateway():
            with self.assertRaises(
                ...
                sale_order_no_recipients._send_request_notification()
