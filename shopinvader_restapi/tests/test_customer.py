...
class TestCustomerCommon(CommonCase):
    ...
    def setUpClass(cls):
        ...
        cls.partner_binding = cls.env.ref("shopinvader_restapi.shopinvader_partner_1")
        cls.address = cls.env.ref("shopinvader_restapi.partner_1_address_1")
        cls.partner_2 = cls.env.ref("shopinvader_restapi.partner_2")
...
class TestCustomer(TestCustomerCommon):
    ...
    def test_address_type(self):
        ...
        address = self.env.ref("shopinvader_restapi.partner_1_address_1")
