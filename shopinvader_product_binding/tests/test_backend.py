...
class BackendCase(ProductCommonCase):
    ...
    def _setup_bind_all_products(self):
        ...
        prod1 = self.env.ref(
            "shopinvader_product_binding.product_template_armchair_mid_century"
        )
        prod2 = self.env.ref(
            "shopinvader_product_binding.product_product_table_walmut"
        ).product_tmpl_id
        prod3 = self.env.ref(
            "shopinvader_product_binding.product_template_chair_mid_century"
        )
        prod4 = self.env.ref(
            "shopinvader_product_binding.product_product_chair_mid_century_red"
        ).product_tmpl_id
