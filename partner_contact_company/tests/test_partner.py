...
class TestPartnerName(common.TransactionCase):
    ...
    def setUp(self):
        super(TestPartnerName, self).setUp()
    ...
    def test_contact_name(self):
        partner = self.env.ref('partner_contact_company.partner_test_contact_name')
    ...
    def test_company_contact_name(self):
        partner = self.env.ref('partner_contact_company.partner_test_company_contact_name')
