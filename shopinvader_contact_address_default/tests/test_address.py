...
class TestAddress(CommonAddressCase):
    def test_address_create(self):
        ...
        params.update(
            {
                ...
                "partner_shipping_id": self.address_2.id,
            }
        )
        ...
        self.assertEqual(partner.partner_shipping_id, self.address_2)
    ...
    def test_address_update(self):
        ...
        self.assertEqual(self.partner.partner_shipping_id, self.address_2)

    def test_address_update_clear(self):
        self.partner.partner_invoice_id = self.address
        self.partner.partner_shipping_id = self.address_2
        params = {
        ...
        self.assertFalse(self.partner.partner_shipping_id)
    ...
    def test_address_read(self):
        ...
        self.assertEqual(data["partner_shipping_id"]["id"], self.address_2.id)
